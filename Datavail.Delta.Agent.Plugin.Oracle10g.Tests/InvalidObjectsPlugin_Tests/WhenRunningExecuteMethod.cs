...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.InvalidObjectsPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["Schema"]).Returns("DB_WAREHOUSE");
            dataReader.Setup(r => r["Name"]).Returns("XBUILD_CONTROL_FILES");
            dataReader.Setup(r => r["Id #"]).Returns("71757");
            dataReader.Setup(r => r["Type"]).Returns("PROCEDURE");
            dataReader.Setup(r => r["Status"]).Returns("INVALID");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new InvalidObjectsPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("InvalidObjectsPluginInput",
        ...
        [TestMethod]
        public void ThenSchemaIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("schema=\"DB_WAREHOUSE"));
        }
        ...
        public void ThenNameIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("name=\"XBUILD_CONTROL_FILES"));
        }

        [TestMethod]
        public void ThenIdIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("id=\"71757"));
        }

        [TestMethod]
        public void ThenTypeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("type=\"PROCEDURE"));
        }

        [TestMethod]
        public void ThenStatuseIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("status=\"INVALID"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new InvalidObjectsPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new InvalidObjectsPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("InvalidObjectsPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
