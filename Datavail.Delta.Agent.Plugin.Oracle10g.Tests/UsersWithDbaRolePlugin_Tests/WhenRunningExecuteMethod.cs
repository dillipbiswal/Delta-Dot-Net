...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.UsersWithDbaRolePlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["USERNAME"]).Returns("SYSMAN");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new UsersWithDbaRolePlugin(common.Object, dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("UsersWithDbaPluginInput",
        ...
        public void ThenUserNameIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("userName=\"SYSMAN"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new UsersWithDbaRolePlugin(common.Object, dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new UsersWithDbaRolePlugin(common.Object, dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("UsersWithDbaPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
