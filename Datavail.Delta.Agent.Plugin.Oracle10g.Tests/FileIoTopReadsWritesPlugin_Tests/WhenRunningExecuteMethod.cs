...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.FileIoTopReadsWritesPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["FILENUM"]).Returns("1");
            dataReader.Setup(r => r["FILE"]).Returns("/data01/oradata/test10g/system01.dbf");
            dataReader.Setup(r => r["Phys. Reads"]).Returns("500");
            dataReader.Setup(r => r["Avg. ReadTime"]).Returns(".555");
            dataReader.Setup(r => r["Phys. Writes"]).Returns("400");
            dataReader.Setup(r => r["Avg WriteTime"]).Returns(".444");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new FileIoTopReadsWritesPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("FileIoTopReadsWritesPluginInput",
        ...
        [TestMethod]
        public void ThenFileNumIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("fileNum=\"1"));
        }
        ...
        public void ThenFileIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("file=\"/data01/oradata/test10g/system01.dbf"));
        }

        [TestMethod]
        public void ThenPhysicalReadsIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("physicalReads=\"500"));
        }

        [TestMethod]
        public void ThenAverageReadTimeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("averageReadTime=\".555"));
        }

        [TestMethod]
        public void ThenPhysicalWritesIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("physicalWrites=\"400"));
        }

        [TestMethod]
        public void ThenAverageWriteTimeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("averageWriteTime=\".444"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new FileIoTopReadsWritesPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new FileIoTopReadsWritesPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("FileIoTopReadsWritesPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
