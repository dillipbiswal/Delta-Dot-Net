...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.TableSpaceDataFilesThatAutoExtendPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["Filesystem"]).Returns("/dat");
            dataReader.Setup(r => r["autoextensible"]).Returns("YES");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new TableSpaceDataFilesThatAutoExtendPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("TableSpaceDataFilesThatAutoExtendPluginInput",
        ...
        [TestMethod]
        public void ThenFilesystemIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("filesystem=\"/dat"));
        }

        [TestMethod]
        public void ThenAutoExtensibleIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("autoExtensible=\"YES"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new TableSpaceDataFilesThatAutoExtendPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new TableSpaceDataFilesThatAutoExtendPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("TableSpaceDataFilesThatAutoExtendPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
