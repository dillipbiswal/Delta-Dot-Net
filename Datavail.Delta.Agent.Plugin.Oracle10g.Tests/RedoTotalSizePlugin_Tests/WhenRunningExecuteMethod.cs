...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.RedoTotalSizePlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["FIRSTTIME"]).Returns("21-MAR-11");
            dataReader.Setup(r => r["GBYTES"]).Returns(".012345");
            dataReader.Setup(r => r["CNT"]).Returns("1");
            dataReader.Setup(r => r["AVG_PER_HR"]).Returns(".543210");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new RedoTotalSizePlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("RedoTotalSizePluginInput",
        ...
        [TestMethod]
        public void ThenFirstTimeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("firstTime=\"21-MAR-11"));
        }

        [TestMethod]
        public void ThenGBytesIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("gBytes=\".012345"));
        }

        [TestMethod]
        public void ThenCountIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("count=\"1"));
        }

        [TestMethod]
        public void ThenAveragePerHourIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("averagePerHour=\".543210"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new RedoTotalSizePlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new RedoTotalSizePlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("RedoTotalSizePluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
