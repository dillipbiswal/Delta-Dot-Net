...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.TotalReadsWritesByFilesystemPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new TotalReadsWritesByFilesystemPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("TotalReadWritesByFilesystemPluginInput",
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new TotalReadsWritesByFilesystemPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new TotalReadsWritesByFilesystemPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("TotalReadWritesByFilesystemPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
