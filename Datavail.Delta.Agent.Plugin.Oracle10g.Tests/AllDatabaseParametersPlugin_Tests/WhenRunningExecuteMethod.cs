...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.AllDatabaseParametersPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["INIT_PARAMETER_NAME"]).Returns("sql_trace");
            dataReader.Setup(r => r["INIT_PARAMETER_VALUE"]).Returns("FALSE");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new AllDatabaseParametersPlugin(dataUploader.Object, logger.Object,
        ...
        public void ThenNameUsedIsUploaded()
        {
            ...
            var plugin = new AllDatabaseParametersPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("AllDatabaseParametersPluginnInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("name=\"sql_trace"));
        }
        ...
        public void ThenValueIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("value=\"FALSE"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new AllDatabaseParametersPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new AllDatabaseParametersPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("AllDatabaseParametersPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
