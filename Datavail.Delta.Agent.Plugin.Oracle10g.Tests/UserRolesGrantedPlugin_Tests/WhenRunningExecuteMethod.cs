...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.UserRolesGrantedPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["GRANTEE"]).Returns("SYSMAN");
            dataReader.Setup(r => r["GRANTED_ROLE"]).Returns("DBA");
            dataReader.Setup(r => r["ADM"]).Returns("YES");
            dataReader.Setup(r => r["DEF"]).Returns("YES");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new UserRolesGrantedPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("UserRolesGrantedPluginInput",
        ...
        [TestMethod]
        public void ThenGranteeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("grantee=\"SYSMAN"));
        }

        [TestMethod]
        public void ThenGrantedRoleIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("grantedRole=\"DBA"));
        }

        [TestMethod]
        public void ThenADMIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("adm=\"YES"));
        }

        [TestMethod]
        public void ThenDEFIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("def=\"YES"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new UserRolesGrantedPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new UserRolesGrantedPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("UserRolesGrantedPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
