...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.ObjectsWithoutStatisticsPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["Object Type"]).Returns("Index");
            dataReader.Setup(r => r["Schema"]).Returns("WMSYS");
            dataReader.Setup(r => r["Name"]).Returns("SYS_C002968");
            dataReader.Setup(r => r["Partition Name"]).Returns("test partition name");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new ObjectsWithoutStatisticsPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("ObjectsWithouStatisticsPluginInput",
        ...
        [TestMethod]
        public void ThenObjectTypeUsedIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("objectType=\"Index"));
        }

        [TestMethod]
        public void ThenValueIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("schema=\"WMSYS"));
        }
        ...
        public void ThenNameIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("name=\"SYS_C002968"));
        }

        [TestMethod]
        public void ThenPartitionNameInMbIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("partitionName=\"test partition name"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new ObjectsWithoutStatisticsPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new ObjectsWithoutStatisticsPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("ObjectsWithouStatisticsPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
