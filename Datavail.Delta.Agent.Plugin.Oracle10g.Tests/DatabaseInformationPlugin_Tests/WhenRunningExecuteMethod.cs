...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.DatabaseInformationPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["INSTANCE_NUMBER"]).Returns("1");
            dataReader.Setup(r => r["INSTANCE_NAME"]).Returns("test10g");
            dataReader.Setup(r => r["CREATED"]).Returns("03/30/2010");
            dataReader.Setup(r => r["HOST_NAME"]).Returns("LinuxOracle10g");
            dataReader.Setup(r => r["VERSION"]).Returns("10.2.0.4.0");
            dataReader.Setup(r => r["STARTUP_TIME"]).Returns("05/04/2011");
            dataReader.Setup(r => r["STATUS"]).Returns("OPEN");
            dataReader.Setup(r => r["PARALLEL"]).Returns("NO");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new DatabaseInformationPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("DatabaseInformationPluginInput",
        ...
        [TestMethod]
        public void ThenInstanceNumberIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("instanceNumber=\"1"));
        }

        [TestMethod]
        public void ThenInstanceNameIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("instanceName=\"test10g"));
        }

        [TestMethod]
        public void ThenCreatedIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("created=\"03/30/2010"));
        }

        [TestMethod]
        public void ThenHostNameIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("hostName=\"LinuxOracle10g"));
        }

        [TestMethod]
        public void ThenVersionIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("version=\"10.2.0.4.0"));
        }
        ...
        public void ThenStatusIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("status=\"OPEN"));
        }

        [TestMethod]
        public void ThenStartupTimeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("startupTime=\"05/04/2011"));
        }

        [TestMethod]
        public void ThenParallelIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("parallel=\"NO"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new DatabaseInformationPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new DatabaseInformationPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("DatabaseInformationPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
