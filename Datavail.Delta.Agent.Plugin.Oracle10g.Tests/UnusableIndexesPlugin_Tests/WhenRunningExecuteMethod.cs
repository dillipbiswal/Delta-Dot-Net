...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.UnusableIndexesPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["OWNER"]).Returns("SCOTT");
            dataReader.Setup(r => r["INDEX_NAME"]).Returns("PK_DEPT");
            dataReader.Setup(r => r["STATUS"]).Returns("UNUSABLE");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new UnusableIndexesPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("UnusableIndexesPluginInput",
        ...
        [TestMethod]
        public void ThenOwnerIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("owner=\"SCOTT"));
        }

        [TestMethod]
        public void ThenIndexNameIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("indexName=\"PK_DEPT"));
        }
        ...
        public void ThenStatusIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("status=\"UNUSABLE"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new UnusableIndexesPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new UnusableIndexesPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("UnusableIndexesPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
