...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.GatherStatsParametersPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["Parameter"]).Returns("CASCADE");
            dataReader.Setup(r => r["Value"]).Returns("DBMS_STATS.AUTO_CASCADE");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new GatherStatsParametersPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("GatherStatsParametersPluginInput",
        ...
        [TestMethod]
        public void ThenParameterIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("parameter=\"CASCADE"));
        }
        ...
        public void ThenValueIsUploaded()
        {
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("value=\"DBMS_STATS.AUTO_CASCADE"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new GatherStatsParametersPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new GatherStatsParametersPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("GatherStatsParametersPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
