...
namespace Datavail.Delta.Agent.Plugin.Oracle10g.Tests.RolesWithPrivilegesGrantedPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethod
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["GRANTEE"]).Returns("XDB");
            dataReader.Setup(r => r["PRIVILEGE"]).Returns("ALTER SESSION");
            dataReader.Setup(r => r["ADMIN_OPTION"]).Returns("NO");
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new RolesWithPrivilegesPlugin(dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("RolesWithPrivilegesPluginInput",
        ...
        [TestMethod]
        public void ThenGranteeUsedIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("grantee=\"XDB"));
        }

        [TestMethod]
        public void ThenPrivilegeIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("privilege=\"ALTER SESSION"));
        }

        [TestMethod]
        public void ThenAdminOptionIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            //Assert
            Assert.IsTrue(uploadedData.Contains("adminOption=\"NO"));
        }
        ...
        public void ThenProductIsPopulatedInUploadedData()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new RolesWithPrivilegesPlugin(dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var logger = new Mock<IDeltaLogger>();
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new RolesWithPrivilegesPlugin(dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("RolesWithPrivilegesPluginInput",
                                         new XAttribute("ConnectionString", connectionString),
                                         new XAttribute("InstanceName", MockInstanceName));
