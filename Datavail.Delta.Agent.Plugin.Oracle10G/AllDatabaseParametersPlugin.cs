...
{
    public class AllDatabaseParametersPlugin : IPlugin   
    {
        ...
        public AllDatabaseParametersPlugin()
        {
        ...
        public AllDatabaseParametersPlugin(IDataQueuer dataQueuer, IDeltaLogger logger, ISqlRunner sqlRunner, IDatabaseServerInfo oracleServerInfo)
        {
        ...
        private void GetAllDatabaseParameters()
        {
            var resultCode = "-1";
            ...
            sql.AppendLine("SELECT  name init_parameter_name, ");
            sql.AppendLine("value init_parameter_value ");
            sql.AppendLine("FROM    v$parameter ");
            ...
            if (result.FieldCount > 0)
            {
                while (result.Read())
                {
                    ...
                    resultCode = "0";
                    resultMessage = "All Database parameters returned: " + _instanceName;
