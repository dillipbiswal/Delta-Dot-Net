...
{
    public class ListenerStatusPlugin : IPlugin   
    {
        ...
        public ListenerStatusPlugin(IDataQueuer dataQueuer, IDeltaLogger logger, ISqlRunner sqlRunner, IDatabaseServerInfo oracleServerInfo)
        {
        ...
        {
            _logger.LogDebug(String.Format("ListenerStatusPlugin.Execute called. MetricInstanceId: {0} Label: {1} Data: {2}",
        ...
        {
            var xml = new XElement("ListenerStatusPluginOutput",
                                   ...
                                   new XAttribute("ListenerStatus", instanceStatus));
