...
namespace Datavail.Delta.Agent.Plugin.SqlServer2005.Tests.SqlAgentStatusPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethodOnNonCluster
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["sqlinstanceuptime"]).Returns("18d 3h 7m");
            dataReader.Setup(r => r["sqlagentstatus"]).Returns("Running.");
        ...
        private static XElement GetInputData()
        {
            ...
            return new XElement("SqlAgentStatusPluginInput",
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var plugin = new SqlAgentStatusPlugin(clusterInfo.Object, dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
            
            var inputData = GetInputData();
            
            var additionalProgramNames = new XElement("ProgramNames", new XElement("ProgramName", "ProgramName1"), new XElement("ProgramName", "ProgramName2"));
            inputData.Add(additionalProgramNames);
        ...
        [TestMethod]
        public void ThenNoSqlAgentStatusFoundIsUploaded()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            var plugin = new SqlAgentStatusPlugin(clusterInfo.Object, dataUploader.Object, logger.Object, sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("SqlAgentStatusInputPluginInput", new XAttribute("ConnectionString", connectionString), new XAttribute("InstanceName", "MockInstanceName"), new XAttribute("JobName", "TestJobName"));
            ...
            Assert.IsTrue(uploadedData.Contains("resultMessage=\"Instance status not returned.\""));
        ...
        [TestMethod]
        public void ThenSqlInstanceUptimeIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("sqlInstanceUptime=\"18d 3h 7m"));
        }

        [TestMethod]
        public void ThenSqlAgentStatusIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("sqlAgentStatus=\"Running."));
        }
        ...
        public void ThenLogEntryIsWrittenWhenExceptionIsThrown()
        {
            ...
            var sqlServerInfo = SetupMockSqlServerInfo();
            var plugin = new SqlAgentStatusPlugin(clusterInfo.Object, dataUploader.Object, logger.Object, sqlRunner.Object, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("SqlAgentStatusInputPluginInput", new XAttribute("ConnectionString", connectionString),
