...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function webforms() {
        ...
        Modernizr['input'] = (function( props ) {
            ...
            if (attrs.list){
              // safari false positive's on Contentslist: webk.it/74252
              // see also github.com/Modernizr/Modernizr/issues/146
              attrs.list = !!(document.createElement('Contentslist') && window.HTMLDataListElement);
            }
            return attrs;
    ...
    ;(function(window, document) {
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr article aside audio bdi canvas Contents Contentslist details figcaption figure footer header hgroup mark meter nav output progress section summary time video',
