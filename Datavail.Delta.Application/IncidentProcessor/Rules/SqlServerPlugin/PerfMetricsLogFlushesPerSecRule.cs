...
namespace Datavail.Delta.Application.IncidentProcessor.Rules.SqlServerPlugin
{
    public sealed class PerfMetricsLogFlushesPerSecRule : IncidentProcessorRule
    {
        ...
        protected override void SetupMatchParams()
        {
            ...
            MatchTypeValue = "Log Flushes/Sec";
        ...
        {
            var message = string.Format(ServiceDeskMessage, MatchTypeValue, MetricInstanceId, _logFlushesPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageCount, MatchTypeValue, MetricInstanceId, metricThreshold.NumberOfOccurrences, metricThreshold.TimePeriod, _logFlushesPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageAverage, MatchTypeValue, Label, MetricInstanceId, average, metricThreshold.TimePeriod, _logFlushesPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        
        protected override void ParseDataCollection(XDocument dataCollection)
        {
            var XLogFlushesPerSec = dataCollection.Root.Attribute("logFlushesPerSec");
            if (XLogFlushesPerSec != null)
            {
                _logFlushesPerSec = long.Parse(XLogFlushesPerSec.Value);
            }
