...
namespace Datavail.Delta.Application.IncidentProcessor.Rules.SqlServerPlugin
{
    public sealed class PerfMetricsPageSplitsPerSecRule : IncidentProcessorRule
    {
        ...
        protected override void SetupMatchParams()
        {
            ...
            MatchTypeValue = "Page Splits/Sec";
        ...
        {
            var message = string.Format(ServiceDeskMessage, MatchTypeValue, MetricInstanceId, _pageSplitsPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageCount, MatchTypeValue, MetricInstanceId, metricThreshold.NumberOfOccurrences, metricThreshold.TimePeriod, _pageSplitsPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageAverage, MatchTypeValue, Label, MetricInstanceId, average, metricThreshold.TimePeriod, _pageSplitsPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        
        protected override void ParseDataCollection(XDocument dataCollection)
        {
            var XPageSplitsPerSec = dataCollection.Root.Attribute("pageSplitsPerSec");
            if (XPageSplitsPerSec != null)
            {
                _pageSplitsPerSec = long.Parse(XPageSplitsPerSec.Value);
            }
