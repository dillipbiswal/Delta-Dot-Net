...
namespace Datavail.Delta.Application.IncidentProcessor.Rules.SqlServerPlugin
{
    public sealed class PerfMetricsPageLifeExpectencyRule : IncidentProcessorRule
    {
        ...
        protected override void SetupMatchParams()
        {
            ...
            MatchTypeValue = "Page Life Expectency";
        ...
        {
            var message = string.Format(ServiceDeskMessage, MatchTypeValue, MetricInstanceId, _pageLifeExpectancy, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageCount, MatchTypeValue, MetricInstanceId, metricThreshold.NumberOfOccurrences, metricThreshold.TimePeriod, _pageLifeExpectancy, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageAverage, MatchTypeValue, Label, MetricInstanceId, average, metricThreshold.TimePeriod, _pageLifeExpectancy, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }

        protected override void ParseDataCollection(XDocument dataCollection)
        {
            var XPageLifeExpectancy = dataCollection.Root.Attribute("pageLifeExpectancy");
            if (XPageLifeExpectancy != null)
            {
                _pageLifeExpectancy = long.Parse(XPageLifeExpectancy.Value);
            }
