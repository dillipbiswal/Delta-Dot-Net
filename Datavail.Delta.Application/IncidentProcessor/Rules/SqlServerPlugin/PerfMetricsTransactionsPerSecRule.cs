...
{
    public sealed class PerfMetricsTransactionsPerSecRule : IncidentProcessorRule
    {
        private long _transactionsPerSec;
        ...
        protected override void SetupMatchParams()
        {
            ...
            MatchTypeValue = "Transactions/Sec";
            PercentageTypeValue = 0;
            ValueTypeValue = 60000;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessage, MatchTypeValue, MetricInstanceId, _transactionsPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageCount, MatchTypeValue, MetricInstanceId, metricThreshold.NumberOfOccurrences, metricThreshold.TimePeriod, _transactionsPerSec, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress, _instanceName);
            return message;
        }
        ...
        protected override void ParseDataCollection(XDocument dataCollection)
        {
            ...
            if (XTransactionsPerSec != null)
            {
                _transactionsPerSec = long.Parse(XTransactionsPerSec.Value);
            }
