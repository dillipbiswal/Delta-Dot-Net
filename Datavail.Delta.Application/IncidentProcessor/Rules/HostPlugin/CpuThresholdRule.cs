...
namespace Datavail.Delta.Application.IncidentProcessor.Rules.HostPlugin
{
    public sealed class CpuThresholdRule : IncidentProcessorRule
    {
        ...
        {
            var message = string.Format(ServiceDeskMessage, MetricInstanceId, _percentageCpuUsed, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageCount, MetricInstanceId, count, metricThreshold.TimePeriod, _percentageCpuUsed, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress);
            return message;
        }
        ...
        {
            var message = string.Format(ServiceDeskMessageAverage, MetricInstanceId, average, metricThreshold.TimePeriod, _percentageCpuUsed, metricThreshold.Id, metricThreshold.FloorValue, metricThreshold.CeilingValue, Hostname, ServerId, IpAddress);
            return message;
        }
