...
namespace Datavail.Delta.Application.IncidentProcessor.Rules.HostPlugin
{
    public sealed class LogWatcherMatchStatus : IncidentProcessorRule
    {
        ...
        {
            var message = string.Format(ServiceDeskMatchMessage, _fileName, _matchingLine, MetricInstanceId, metricThreshold.MatchValue, metricThreshold.Id, Hostname, IpAddress);
            return message;
        }
        ...
        protected override string FormatMatchCountServiceDeskMessage(int count, MetricThreshold metricThreshold)
        {
            ...
            var message = string.Format(ServiceDeskMatchCountMessage, _fileName, _matchingLine, MetricInstanceId, count, metricThreshold.TimePeriod, metricThreshold.MatchValue, metricThreshold.Id, Hostname, IpAddress);
            return message;
        }
