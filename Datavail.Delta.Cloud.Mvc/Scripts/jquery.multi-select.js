...
(function($){
  var msMethods = {
        ...
        if (ms.next('.ms-container').length == 0){
          ...
          ms.find('optgroup,option').each(function(){
            ...
            if ($(this).is("option:not(option[value=''])")){
              ...
              var selectableLi = $('<li class="ms-elem-selectable ui-element ui-state-default' + klass + '" ms-value="' + $(this).val() + '">' + $(this).text() + '<span class="ui-corner-all ui-icon ui-icon-plus fr"/></li>');
    ...
    'select' : function(value, method){
      ...
      var selectedLi = $('<li class="ms-elem-selected ui-element ui-state-default' + (klass ? ' ' + klass : '') + '" ms-value="' + value + '">' + text + '<span class="ui-corner-all ui-icon ui-icon-minus fr"/></li>'),
