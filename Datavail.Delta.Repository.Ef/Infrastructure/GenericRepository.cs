...
namespace Datavail.Delta.Repository.Ef.Infrastructure
{
    ...
    public class GenericRepository : IRepository
    {
        ...
        /// </summary>
        public GenericRepository(IDeltaLogger logger)
        ...
        public GenericRepository(string connectionStringName, IDeltaLogger logger)
        {
            _logger = logger;
        ...
        public TEntity GetByKey<TEntity>(object keyValue) where TEntity : class
        {
            ...
            if (
                ((IObjectContextAdapter)DbContext).
                    ObjectContext.TryGetObjectByKey(key,
                                                    out
                                                                                                                  originalItem))
            {
