...
{
    [TestClass]
    public class WhenMatchingNonMatchingJobStatusData
    {
        private XDocument GetNonMatchingXml()
        {
            var xml = new XElement("DatabaseJobStatusPluginOutput",
                                   ...
                                   new XAttribute("jobId", "1"),
                                   new XAttribute("jobStatus", "Failed"),
                                   new XAttribute("message", "The Job 'Test Job' hs Failed."),
                                   new XAttribute("retriesAttempted", 0),
                                   new XAttribute("runDate", "5/5/2011"),
                                   new XAttribute("runDuration", "60"),
                                   new XAttribute("runTime", "60"),
