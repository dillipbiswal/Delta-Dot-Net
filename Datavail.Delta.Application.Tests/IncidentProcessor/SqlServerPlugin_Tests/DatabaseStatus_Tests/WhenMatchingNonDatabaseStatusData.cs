...
namespace Datavail.Delta.Application.Tests.IncidentProcessor.Rules.DatabaseStatus_Tests
{
    [TestClass]
    public class WhenMatchingNonDatabaseStatusData
    {
        ...
        public void ThenItIsNotAMatch()
        {
            ...
            var rule = new DatabaseStatusRule(incidentService.Object, xml, serverService.Object);
