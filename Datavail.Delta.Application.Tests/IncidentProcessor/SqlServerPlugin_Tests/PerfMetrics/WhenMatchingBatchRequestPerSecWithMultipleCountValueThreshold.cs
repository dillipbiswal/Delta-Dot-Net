...
{
    [TestClass]
    public class WhenMatchingBatchRequestPerSecWithMultipleCountValueThreshold
    {
        #region Variables and Helpers
        //Common
        private const string MatchType = "Batch Requests/Sec";
        ...
        private const long BatchRequestsPerSec = 1000000;
        ...
        private IServerService SetupServerService()
        {
            ...
            _metricThreshold = MetricThreshold.NewMetricThreshold(Ceiling, Floor, "1000000", MatchCount, Severity, ThresholdComparisonFunction, ThresholdValueType, TimePeriod, _metricThresholdId);
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricsBatchRequestsPerSecRule(incidentService.Object, xml, serverService);
