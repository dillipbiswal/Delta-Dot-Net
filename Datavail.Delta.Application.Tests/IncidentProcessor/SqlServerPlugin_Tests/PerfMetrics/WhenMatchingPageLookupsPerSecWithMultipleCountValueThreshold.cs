...
{
    [TestClass]
    public class WhenMatchingPageLookupsPerSecWithMultipleCountValueThreshold
    {
        #region Variables and Helpers
        //Common
        private const string MatchType = "Page Lookups/Sec";
        ...
        private const long PageLookupsPerSec = 100000;
        ...
        private IServerService SetupServerService()
        {
            ...
            _metricThreshold = MetricThreshold.NewMetricThreshold(Ceiling, Floor, "100000", MatchCount, Severity, ThresholdComparisonFunction, ThresholdValueType, TimePeriod, _metricThresholdId);
        ...
        public void ThenItIsNotAMatchOnFirstOccurrence()
        {
            ...
            var rule = new PerfMetricsPageLookupsPerSecRule(incidentService.Object, xml, serverService);
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricsPageLookupsPerSecRule(incidentService.Object, xml, serverService);
