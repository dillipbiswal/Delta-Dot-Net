...
{
    [TestClass]
    public class WhenMatchingCheckpointPagesPerSecWithSingleCountMatchThreshold
    {
        ...
        private const long CheckpointPagesPerSec = 2000000;
