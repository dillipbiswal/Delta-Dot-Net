...
{
    [TestClass]
    public class WhenMatchingTransactionsPerSecWithSingleCountValueThreshold
    {
        ...
        private IServerService SetupServerService()
        {
            ...
            _metricThreshold = MetricThreshold.NewMetricThreshold(Ceiling, Floor, "60000", MatchCount, Severity, ThresholdComparisonFunction, ThresholdValueType, TimePeriod, _metricThresholdId);
