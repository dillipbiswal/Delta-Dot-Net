...
{
    [TestClass]
    public class WhenMatchingLogFlushesPerSecWithMultipleCountValueThreshold
    {
        #region Variables and Helpers
        //Common
        private const string MatchType = "Log Flushes/Sec";
        ...
        private const long LogFlushesPerSec = 4000000;
        ...
        private IServerService SetupServerService()
        {
            ...
            _metricThreshold = MetricThreshold.NewMetricThreshold(Ceiling, Floor, "4000000", MatchCount, Severity, ThresholdComparisonFunction, ThresholdValueType, TimePeriod, _metricThresholdId);
        ...
        public void ThenItIsNotAMatchOnFirstOccurrence()
        {
            ...
            var rule = new PerfMetricsLogFlushesPerSecRule(incidentService.Object, xml, serverService);
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricsLogFlushesPerSecRule(incidentService.Object, xml, serverService);
