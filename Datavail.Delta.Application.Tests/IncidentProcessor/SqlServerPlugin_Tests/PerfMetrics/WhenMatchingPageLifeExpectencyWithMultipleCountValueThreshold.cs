...
{
    [TestClass]
    public class WhenMatchingPageLifeExpectencyWithMultipleCountValueThreshold
    {
        #region Variables and Helpers
        //Common
        private const string MatchType = "Page Life Expectency";
        ...
        private const long PageLifeExpectency = 60;
        ...
        public void ThenItIsNotAMatchOnFirstOccurrence()
        {
            ...
            var rule = new PerfMetricsPageLifeExpectencyRule(incidentService.Object, xml, serverService);
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricsPageLifeExpectencyRule(incidentService.Object, xml, serverService);
