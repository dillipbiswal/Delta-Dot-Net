...
{
    [TestClass]
    public class WhenMatchingCheckpointPagesPerSecWithMultipleCountValueThreshold
    {
        #region Variables and Helpers
        //Common
        private const string MatchType = "Checkpoint Pages/Sec";
        ...
        private const long CheckpointPages = 2000000;
        ...
        private const float Ceiling = 2000001;
        ...
        private IServerService SetupServerService()
        {
            ...
            _metricThreshold = MetricThreshold.NewMetricThreshold(Ceiling, Floor, "2000000", MatchCount, Severity, ThresholdComparisonFunction, ThresholdValueType, TimePeriod, _metricThresholdId);
        ...
        public void ThenItIsNotAMatchOnFirstOccurrence()
        {
            ...
            var rule = new PerfMetricsCheckpointPagesPerSecRule(incidentService.Object, xml, serverService);
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricsCheckpointPagesPerSecRule(incidentService.Object, xml, serverService);
