...
{
    [TestClass]
    public class  WhenMatchingLazyWritesPerSecWithMultipleCountValueThreshold
    {
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricsLazyWritesPerSecRule(incidentService.Object, xml, serverService);
