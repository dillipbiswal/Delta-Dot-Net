...
{
    [TestClass]
    public class WhenMatchingSqlCompilationsPerSecWithMultipleCountValueThreshold
    {
        #region Variables and Helpers
        //Common
        private const string MatchType = "Sql Compilations/Sec";
        ...
        private const long SqlCompilationsPerSec = 300000;
        ...
        private IServerService SetupServerService()
        {
            ...
            _metricThreshold = MetricThreshold.NewMetricThreshold(Ceiling, Floor, "300000", MatchCount, Severity, ThresholdComparisonFunction, ThresholdValueType, TimePeriod, _metricThresholdId);
        ...
        public void ThenItIsNotAMatchOnFirstOccurrence()
        {
            ...
            var rule = new PerfMetricSqlCompilationsPerSecRule(incidentService.Object, xml, serverService);
        ...
        public void ThenItIsAMatchOnSecondOccurrence()
        {
            ...
            rule = new PerfMetricSqlCompilationsPerSecRule(incidentService.Object, xml, serverService);
