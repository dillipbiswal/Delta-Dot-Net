...
namespace Datavail.Delta.Agent.Plugin.SqlServer2000.Tests.DatabaseInventoryPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethodOnNonCluster
    {
        ...
        private static readonly Guid MockInstanceId = new Guid("D00BDA0A-B2DA-41B5-A84C-32F9C298D3E8");
        ...
        private static XElement GetInputData()
        {
            ...
            return new XElement("DatabaseInventoryPluginInput",
                                new XAttribute("ConnectionString", connectionString),
                                new XAttribute("DatabaseName", MockDatabaseName),
                                new XAttribute("InstanceId", MockInstanceId),
