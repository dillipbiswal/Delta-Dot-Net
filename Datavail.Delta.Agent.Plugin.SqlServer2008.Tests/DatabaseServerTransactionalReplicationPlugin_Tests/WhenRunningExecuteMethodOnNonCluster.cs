...
namespace Datavail.Delta.Agent.Plugin.SqlServer2008.Tests.DatabaseServerTransactionalReplicationPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethodOnNonCluster
    {
        const string MockDatabaseName = "MockDb";
        private const string TestInstanceName = "TestInstanceName";
        ...
        public void ThenDataIsUploaded()
        {
            ...
            var inputData = new XElement("DatabaseServerTransactionalReplicationPluginInput", new XAttribute("ConnectionString", connectionString), new XAttribute("DistributionDatabaseName", "Test Distributin Database"),
                                         new XAttribute("InstanceName", TestInstanceName));
        ...
        public void ThenTimestampIsPopulatedInUploadedData()
        {
            ...
            var plugin = new DatabaseServerTransactionalReplicationPlugin(clusterInfo.Object, dataUploader.Object, logger.Object, sqlRunner, sqlRunnerPublishers, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("DatabaseServerTransactionalReplicationPluginInput", new XAttribute("ConnectionString", connectionString), new XAttribute("DistributionDatabaseName", "Test Distribution Database"),
                                         new XAttribute("InstanceName", TestInstanceName));
        ...
        public void ThenActionTimeIsPopulatedInUploadedData()
        {
            ...
            var inputData = new XElement("DatabaseServerTransactionalReplicationPluginInput",
                                         ...
                                         new XAttribute("DistributionDatabaseName", "Test Distributin Database"),
                                         new XAttribute("InstanceName", TestInstanceName));
