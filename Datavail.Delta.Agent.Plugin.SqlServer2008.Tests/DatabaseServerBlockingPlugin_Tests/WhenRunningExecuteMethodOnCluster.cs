...
namespace Datavail.Delta.Agent.Plugin.SqlServer2008.Tests.DatabaseServerBlockingPlugin_Tests
{
    ...
    public class WhenRunningExecuteMethodOnCluster
    {
        ...
        public void ThenDataIsNotUploadedWhenNotActiveNode()
        {
            ...
            var plugin = new DatabaseServerBlockingPlugin(clusterInfo.Object, dataUploader.Object, logger.Object,
                                                  sqlRunner, sqlServerInfo);
            var connectionString = SetupMockConnectionString();
            var inputData = new XElement("DatabaseServerBlockingPluginInput",
