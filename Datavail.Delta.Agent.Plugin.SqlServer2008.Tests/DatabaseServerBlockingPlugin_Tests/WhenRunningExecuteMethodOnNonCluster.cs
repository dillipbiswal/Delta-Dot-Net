...
namespace Datavail.Delta.Agent.Plugin.SqlServer2008.Tests.DatabaseServerBlockingPlugin_Tests
{
    [TestClass]
    public class WhenRunningExecuteMethodOnNonCluster
    {
        ...
        private static IDataReader SetupMockDataReader()
        {
            ...
            dataReader.Setup(r => r["db"]).Returns("Master");
            dataReader.Setup(r => r["request_session_id"]).Returns("2");
            dataReader.Setup(r => r["request_session_command"]).Returns("select * from bar");
            dataReader.Setup(r => r["waiting_duration_sec"]).Returns("5");
            dataReader.Setup(r => r["blocking_id"]).Returns("1");
            dataReader.Setup(r => r["blocking_command"]).Returns("insert foo into bar");
        ...
        private static XElement GetInputData()
        {
            ...
            return new XElement("DatabaseServerBlockingPluginInput",
        ...
        [TestMethod]
        public void ThenDbIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("database=\"Master"));
        }

        [TestMethod]
        public void ThenRequestSessionIdIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("requestSessionId=\"2"));
        }

        [TestMethod]
        public void ThenRequestSessionCommandIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("requestSessionCommand=\"select * from bar"));
        }

        [TestMethod]
        public void ThenWaitingDurationSecIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("waitingDurationSec=\"5"));
        }

        [TestMethod]
        public void ThenBlockingIdIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("blockingId=\"1"));
        }

        [TestMethod]
        public void ThenBlockingCommandIsPopulatedInUploadedData()
        {
            //Arrange
            var metricInstanceId = Guid.NewGuid();
            ...
            Assert.IsTrue(uploadedData.Contains("blockingCommand=\"insert foo into bar"));
        }
