using System;
using Datavail.Delta.Cloud.BackgroundWorker.MaintenanceWindows;
using Datavail.Delta.Cloud.BackgroundWorker.ServiceDeskTasks;
using Datavail.Delta.Cloud.BackgroundWorker.StatsTasks;
using Datavail.Delta.Infrastructure.Logging;
using FluentScheduler;
using Microsoft.Practices.Unity;

namespace Datavail.Delta.Cloud.BackgroundWorker.Schedules
{
